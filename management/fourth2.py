...
class FourthQuiz2View(TemplateView):
    template_name = 'auth/login_pages/fourth2.html'
    ...
    def post(self, request):
        ...
        if request.method == 'POST':
            correct_count1, incorrect_count1 = self.compare_answers()
            context = self.get_context_data()
            context['correct_count1'] = correct_count1
            context['incorrect_count1'] = incorrect_count1
    ...
    def compare_answers(self):
        ...
        return correct_count1, incorrect_count1
